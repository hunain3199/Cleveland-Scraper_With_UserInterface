...
first_page = st.number_input("Enter your First Page Number",value=1, step=1)
last_page = st.number_input("Enter your Last Page Number",value=1, step=1)
...
if st.button("Page Links Function and Physician Links Function"):
    ...
    def scrapingPhysiciansLinks(links:list[str]) -> list[str]:
        ...
        chrome_options.add_experimental_option("prefs", {"browser.gatherUsageStats": False})
# Add any necessary options to chrome_options
        chrome_options.binary_location = "C:/Users/hunain3199/Downloads/chrome-win64 (1)/chrome-win64/chrome.exe"  
# Specify the ChromeDriver version
        driver_manager = ChromeDriverManager()  # Replace with the desired version

# Install ChromeDriver and create driver instance
